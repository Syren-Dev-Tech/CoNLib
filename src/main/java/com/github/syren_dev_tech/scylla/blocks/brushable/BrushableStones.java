...
public class BrushableStones {
    ...
    public static final Supplier<CustomBrushableBlock> create(ModRegister register, String name,
    ...
    public static final Supplier<CustomBrushableBlock> create(ModRegister register, String name,
        ...
        return create(register, name, Properties.copy(Blocks.STONE), dustedBlock, SoundEvents.BRUSH_SAND,
                SoundEvents.BRUSH_SAND_COMPLETED, creativeTab);
    }

    public static final Supplier<CustomBrushableBlock> create(ModRegister register, String name, Properties properties,
            Supplier<Block> dustedBlock) {
    ...
    public static final Supplier<CustomBrushableBlock> create(ModRegister register, String name, Properties properties,
            Supplier<Block> dustedBlock, SoundEvent dustingSound, SoundEvent dustingCompletedSound) {
