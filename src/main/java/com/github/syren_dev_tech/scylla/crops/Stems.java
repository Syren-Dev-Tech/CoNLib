...
public class Stems {
    public static class AttachedStems {
        ...
        public static final Supplier<AttachedStemBlock> create(ModRegister register, String name, StemGrownBlock fruit,
                Item seeds) {
        ...
        public static final Supplier<AttachedStemBlock> create(ModRegister register, String name, Properties properties,
    ...
    public static class GrowingStems {
        ...
        public static final Supplier<StemBlock> create(ModRegister register, String name, StemGrownBlock fruit,
                Item seeds) {
            return register.blockRegistry.register(name,
                    () -> new StemBlock(fruit, () -> seeds, Properties.copy(Blocks.PUMPKIN_STEM)));
        }

        public static final Supplier<StemBlock> create(ModRegister register, String name, Properties properties,
                StemGrownBlock fruit, Item seeds) {
            return register.blockRegistry.register(name, () -> new StemBlock(fruit, () -> seeds, properties));
        }
    }

    public static final Tuple<Supplier<StemBlock>, Supplier<AttachedStemBlock>> create(ModRegister register,
            String name, Properties properties, StemGrownBlock fruit, Item seeds) {
    ...
    public static final Tuple<Supplier<StemBlock>, Supplier<AttachedStemBlock>> create(ModRegister register,
            String name, StemGrownBlock fruit, Item seeds) {
