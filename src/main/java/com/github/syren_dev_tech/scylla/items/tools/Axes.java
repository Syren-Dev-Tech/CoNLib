...
public class Axes {
    ...
    public static final Supplier<AxeItem> create(ModRegister register, String name, Properties properties, Tier tier) {
        return create(register, name, new Properties(), tier, 6, -3.1F);
    }

    public static final Supplier<AxeItem> create(ModRegister register, String name, Properties properties, Tier tier,
            ResourceKey<CreativeModeTab> creativeTab) {
        return create(register, name, new Properties(), tier, 6, -3.1F, creativeTab);
    }

    public static final Supplier<AxeItem> create(ModRegister register, String name, Tier tier, Integer attackDamage,
            Float attackSpeed) {
