...
public class Candles {
    ...
    public static class CakeCandles {
        ...
        public static final Supplier<CandleCakeBlock> create(ModRegister register, String name, Properties properties,
                Block standingCandle) {
            return register.blockRegistry.register(name, () -> new CandleCakeBlock(standingCandle, properties));
        }

        public static final Supplier<CandleCakeBlock> create(ModRegister register, String name, Properties properties,
                Block standingCandle, ResourceKey<CreativeModeTab> creativeTab) {
            return register.blockRegistry.register(name, () -> new CandleCakeBlock(standingCandle, properties),
                    creativeTab);
        }
    ...
    public static final Tuple<Supplier<CandleBlock>, Supplier<CandleCakeBlock>> create(ModRegister register,
            String name) {
