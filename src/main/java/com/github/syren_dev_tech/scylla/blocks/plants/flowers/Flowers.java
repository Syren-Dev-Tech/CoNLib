package com.github.syren_dev_tech.scylla.blocks.plants.flowers;

import java.util.function.Supplier;

import com.github.syren_dev_tech.scylla.blocks.plants.flowers.types.CustomFlower;
...
public class Flowers {
    ...
    public static final Supplier<CustomFlower> create(ModRegister register, String name, MobEffect effect,
            Integer duration) {
        return create(register, name, Properties.copy(Blocks.POPPY), effect, duration);
    }

    public static final Supplier<CustomFlower> create(ModRegister register, String name, MobEffect effect,
            Integer duration, ResourceKey<CreativeModeTab> creativeTab) {
        return create(register, name, Properties.copy(Blocks.POPPY), effect, duration, creativeTab);
    }

    public static final Supplier<CustomFlower> create(ModRegister register, String name, Properties properties,
            MobEffect effect, Integer duration) {
        return register.blockRegistry.register(name, () -> new CustomFlower(() -> effect, duration, properties));
    }

    public static final Supplier<CustomFlower> create(ModRegister register, String name, Properties properties,
            MobEffect effect, Integer duration, ResourceKey<CreativeModeTab> creativeTab) {
        return register.blockRegistry.register(name, () -> new CustomFlower(() -> effect, duration, properties),
                creativeTab);
    }
