...
import com.github.chrisofnormandy.conlib.husbandry.types.LargeEgg;
import com.github.chrisofnormandy.conlib.husbandry.types.LargeEggData;
...
public class LargeEggs {
    ...
    public static final <T extends Animal> Supplier<DragonEggBlock> create(ModRegister register, String name, Properties properties, LargeEggData<T> eggData, ResourceKey<CreativeModeTab> creativeTab) {
